...
let fastcgi_cache_size = process.env.fastcgi_cache_size // 100mb
...
let src = fs.readFileSync(`${process.cwd()}/nginx.nossl_cache.conf`,'utf-8')
let dst = []
...
fs.writeFileSync(`${process.cwd()}/${domain}-nossl-cache.conf`, dst.join('\n'))
